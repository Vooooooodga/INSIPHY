...
from insiphy import alignment
from insiphy.coding.projection import _aligned_occurrence_pairs
from insiphy.coding.projection import _anchor_metrics
from insiphy.coding.projection import _candidate_json
from insiphy.coding.projection import _coordinate_blocks0
from insiphy.coding.transcripts import _copy_key
from insiphy.coding.transcripts import build_coding_transcript
from insiphy.coding.types import CodingProjectionCandidate
from insiphy.coding.types import CodingProjectionCandidateSet
from insiphy.coding.types import CodingResidueProjection
from insiphy.coding.types import FamilyCodingProjection
import json
...
from insiphy.coding.projection import (
    _blosum62_score,
...
from insiphy.coding.transcripts import (
    _copy_key,
...
from insiphy.coding.types import (
    _STANDARD_CODE,
    _BLOSUM62,
    _EMPTY,
    _ANCHOR_WINDOW,
