...
def infer_phylogeny(
    ...
    if analysis_scope == "single-copy":
        ...
        from intraphy.run_result import begin_run
        ...
        from intraphy.structural_phylogeny import infer_single_copy_phylogeny
    ...
    from intraphy.experimental.phylogeny import infer_experimental_phylogeny
...
def __getattr__(name):
    if name in _LEGACY_NAMES:
        from intraphy.experimental import phylogeny
