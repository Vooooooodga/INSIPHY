...
from intraphy.reporting.target_model import (LAYER_LABELS, load_targets, resolve_intervals, target_ribbons)
from intraphy.reporting.target_scene import (WIDTH, TRACK_LEFT, TRACK_RIGHT, attr, text, build_scene, scene_data)
...
def _render(scene,target,intervals,matrix,pairs,events,mode,occurrences,scope):
    ...
    if mode in {'ribbons','phylogeny'}:
        ...
        for a,b,ia,ib,mid in pairs:
            ...
            from intraphy.reporting.target_model import TargetInterval
