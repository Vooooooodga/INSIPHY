...
def run_all(
    ...
    logger.info("1/5 Initial sequence correspondence")
    infer_correspondence(input_dir, output_dir)
    logger.info("2/5 Additional sequence evidence")
