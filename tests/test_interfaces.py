...
from insiphy.candidate_chain import (
...
from insiphy.coordinates import (
    ClosedInterval1,
    CoordinateBlock,
    Interval0,
...
class InterfaceTests(unittest.TestCase):
    ...
    def test_run_defaults_to_repertoire_annotation_view(self):
        with tempfile.TemporaryDirectory() as tmp, patch("insiphy.cli.run_all") as run:
            main([
                "run",
                "--input-dir", tmp,
                "--output-dir", str(Path(tmp) / "out"),
